...
const config: Config = {
  ...
  theme: {
    ...
    colors: {
      ...
      "primary-container": "rgb(var(--color-primary-container) / <alpha-value>)", // よりbgに近い、明るいテーマ色(FAB(浮いて見えるボタン)や、トグルの塗りつぶし、input要素の塗りつぶしなどに用いる)
      "on-primary-container" : "rgb(var(--color-on-primary-container) / <alpha-value>)", // primary-containerが背景の時の文字色
      ...
      "secondary-container": "rgb(var(--color-secondary-container) / <alpha-value>)", // 明るい(目立たない)secondary色
      "on-secondary-container": "rgb(var(--color-on-secondary-container) / <alpha-value>)", // secondary-containerが背景の時の文字色
      ...
      "tertiary-container": "rgb(var(--color-tertiary-container) / <alpha-value>)", // 明るいtertiary色
      "on-tertiary-container": "rgb(var(--color-on-tertiary-container) / <alpha-value>)", // tertiary-containerが背景の時の文字色
      ...
      "on-error-container": "rgb(var(--color-on-error-container) / <alpha-value>)", // error-containerが背景の時の文字色
      ...
      "on-surface-variant": "rgb(var(--color-on-surface-variant) / <alpha-value>)", // surface-variantが背景の時の文字色
