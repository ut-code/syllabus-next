...
const disclaimer: React.FC = () => { 
  return <>
    <HowToUseItem title="免責事項">
      ...
      本サービスにより提供されているデータは、UTAS(https://utas.adm.u-tokyo.ac.jp/campusweb/campusportal.do)と東京大学授業カタログ(https://catalog.he.u-tokyo.ac.jp)がオンラインで公開している情報をベースとしています。データの正確性に関しては保証いたしかねますので、履修の際は必ず公式の資料に目を通してください。本サービスの利用によって生じたいかなる損害についても ut.code(); は責任を負いません。
      </FaqItem>
      ...
      本サービスは ut.code(); によって運営されており、東京大学は一切運営に関与していません。本サービスが提供するデータは教養学部前期課程教務課に確認の上、機械的に取得されたものです。なお、本サービスで利用されているデータの一切は ut.code(); が保有するサーバーに保存されています。
      </FaqItem>
