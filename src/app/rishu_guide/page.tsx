      ...
      <main style={{ paddingTop: "60px" }}>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  A~C系列：2系列以上にわたり
                  <span style={{ color: "red" }}>6</span>単位以上
                </li>
                <li>
                  D~F系列：2系列以上にわたり
                  <span style={{ color: "red" }}>6</span>単位以上
                ...
                <li>
                  ...
                  単位以上(既修外国語が英語の場合)、
                  初修外国語の演習①と②、その他から
                  <span style={{ color: "red" }}>2</span>単位以上
                </li>
              </ul>
            </li>
            <li>
              主題科目：<span style={{ color: "red" }}>2</span>単位以上
            </li>
            <li>展開科目：0単位以上(履修しなくても良い)</li>
            <li>
              さらに、前期課程修了に必要な単位：
              <span style={{ color: "red" }}>4</span>単位
            </li>
          </ul>
        </ul>
        <ul style={{ border: "2px solid #000" }}>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  A~C、L系列：「英語中級」「英語上級」から
                  <span style={{ color: "red" }}>3</span>
                  単位以上(既修外国語が英語の場合)、
                  初修外国語の演習①と②、その他から3系列以上にわたり
                  <span style={{ color: "red" }}>10</span>単位以上
                </li>
                <li>
                  D~F系列：2系列以上にわたり
                  <span style={{ color: "red" }}>8</span>単位以上
                </li>
              </ul>
            </li>
            <li>
        ...
        <ul style={{ border: "2px solid #000" }}>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  L系列：「英語中級」「英語上級」から
                  <span style={{ color: "red" }}>3</span>
                  単位以上(既修外国語が英語の場合)、 その他から0単位以上 <br />{" "}
            ...
            <li>展開科目：0単位以上(履修しなくても良い)</li>
            <li>
              さらに、前期課程修了に必要な単位：理科一類は
              <span style={{ color: "red" }}>3</span>単位、理科二類と理科三類は
              <span style={{ color: "red" }}>2</span>単位
            </li>
          </ul>
        </ul>
        <h2>進学に必要な単位(基礎科目)</h2>
        <ul style={{ border: "2px solid #000" }}>
          ...
          <ul>
            ...
            <li>
              情報(希望者は発展内容を扱う
              <span style={{ color: "blue" }}>情報α</span>に変更可。)
            </li>
            <li>身体運動・健康科学実習</li>
            <li>初年次ゼミナール文科</li>
            <li>
              ...
              から2分野以上にわたり<span style={{ color: "red" }}>4</span>
              単位以上)
            </li>
            <li>
              社会科学(「法Ⅰ
              ...
              法Ⅱ」または「政治Ⅰ
              <span style={{ color: "red", fontWeight: "bold" }}>+</span>
              政治Ⅱ」を含み<span style={{ color: "red" }}>8</span>単位以上)
            </li>
          </ul>
        </ul>
        <ul style={{ border: "2px solid #000" }}>
        ...
        <ul style={{ border: "2px solid #000" }}>
          ...
          <ul>
            ...
            <li>初年次ゼミナール理科</li>
            <li>
              人文科学・社会科学から<span style={{ color: "red" }}>6</span>
              単位以上
            </li>
            <li>
              数学・統計<span style={{ color: "red" }}>8</span>
              単位以上(理科三類は<span style={{ color: "red" }}>4</span>
              単位以上)
            </li>
