    ...
    <div>
      ...
      <ul className="list-disc pl-5 space-y-3">
            <li>
              ...
              <span className="text-red-600 font-bold underline">初年次ゼミナール</span>
              には抽選があるので、期日までに希望を出す
            </li>
            <li>クラス指定の総合科目は必ずしも履修する必要はない</li>
            <li>
              1セメスターにつき、履修可能なのは
              <span className="text-red-600">30</span>単位まで (集中講義, TLPを除く)
            </li>
      ...
      <HowToUseItem title="進学に必要な単位(基礎科目以外)　※既習外国語が英語の場合">
        <div className="grid gap-6 md:grid-cols-2">
          <div className="border-2 border-primary p-4 rounded-lg">
            <h3 className="text-xl font-bold text-blue-600">文科一類、文科二類</h3>
            <ul className="list-disc pl-5 space-y-2">
            <li>
                総合A~C系列：2系列以上で<span className="text-red-600">6</span>単位
              </li>
              <li>
                総合D~F系列：2系列以上で<span className="text-red-600">6</span>単位
              </li>
              <li>
          ...
          <div className="border-2 border-primary p-4 rounded-lg col-span-2">
            <h3 className="text-xl font-bold text-blue-600">理科一類、理科二類、理科三類</h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                総合A~D系列：2系列以上にわたり6単位以上
              </li>
              <li>
                総合E~F系列：2系列以上にわたり6単位以上
              </li>
              <li>
