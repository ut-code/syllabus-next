...
export const SampleClasses: ClassDataType[]=[{
    ...
    category: "数理科学",
    semester: "S1",
    dayPeriod: [{ "day": "mon", "period": 1 }, { "day": "wed", "period": 1 } ],
