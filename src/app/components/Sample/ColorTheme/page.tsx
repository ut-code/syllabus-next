      ...
      <div className="w-1/2 p-4">
        ...
        <div className="mt-4">
          <div className="grid grid-cols-2 justify-center items-center gap-2">
            ...
            <div className="col-start-1 col-span-1 row-start-1 p-4 bg-primary text-on-primary">Primary</div>

            {/* FABは、primary-containerを利用推奨 */}
            <div className="col-start-2 col-span-1 row-start-1 p-4 bg-primary-container text-on-primary-container shadow rounded-full text-center">Float Button</div>
