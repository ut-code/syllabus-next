...
export const Freeword: React.FC<FreewordProp> = (prop: FreewordProp) => {
  ...
  return (<div>
    <input placeholder={"フリーワード : " + (isFreewordForSyllabusDetail ? "授業情報全体" : "講義名")}></input>
    <Checkbox label={"授業情報全体を検索"} checked={isFreewordForSyllabusDetail} onChange={prop.setFreewordTarget}></Checkbox>
  </div>);
};
