...
import { ClassSlot, DaySlot, IntensiveClassSlot, PeriodSlot, PosV, SlotDiv } from "./slot";
...
function slotRow(
  ...
  return (
    <>
      {/* 曜限のヘッダー */}
      <PeriodSlot period={period} pos_v={pos_v} pos_h={"left"}>
        {period}
      </PeriodSlot>
      {day.map((d) => {
        return (
          ...
          hasSaturday = {hasSaturday}
            ...
            pos_v={pos_v}
            pos_h={d == day[day.length - 1] ? "right" : "left"}
          />
        );
      })}
    </>
